...
export default function InterviewForm() {
  ...
  const canAdvance = useCallback(() => {
    if (step === 0) return form.ageRange && form.gender && form.lat !== null;
      ...
      >
        ...
        {step === 0 && (
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            <div>
              ...
              >
                Click the map to place a pin at the approximate location. Drag
                to adjust.
              </p>
              <LocationPicker
                lat={form.lat}
        ...
        {step === 1 && (
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            <p
              style={{ fontSize: 14, color: "var(--gray-300)", marginTop: -12 }}
            >
